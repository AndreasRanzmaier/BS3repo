...
select concat_ws(' ', per_vname, per_nname) as "Schueler 4. Klasse 2020/2021" 
from schueler
...
select
concat_ws(' ', scja_name, kla_name) as 'Schuljahr / Klasse', count(per_id) as 'Anzahl der Schüler'
from schuljahr
inner join schuljahr_klasse using(scja_id)
...
select concat_ws(' ', per_vname, per_nname) as "Schueler*in ohne Schuljahrzuordnung"
from person
...
select kla_name as "Klasse",
count(scja_id) as "Anzahl Schuljahre"
from klasse 
